...
echo "DarkPipe Stalwart entrypoint wrapper starting..."
...
echo "Starting Stalwart for domain: ${MAIL_DOMAIN}"

# Execute the original stalwart-mail binary with all arguments
